...
class Logger {
  ...
  void log(Map<String, String>? TESTMESSAGE, Level logLevel, Object? message,
    ...
    if (isLoggable(logLevel)) {
      ...
      if (stackTrace == null && logLevel >= recordStackTraceAtLevel) {
        ...
        error ??= 'autogenerated stack trace for $logLevel';
      }
      zone ??= Zone.current;

      var record =
          LogRecord(TESTMESSAGE, logLevel, message, fullName, error, stackTrace, zone, object);
  ...
  /// handled.
  void finest(Map<String, String>? TESTMESSAGE, Object? message, [Object? error, StackTrace? stackTrace]) =>
  ...
  /// See [log] for information on how non-String [message] arguments are
  /// handled.
  void finer(Map<String, String>? TESTMESSAGE, Object? message, [Object? error, StackTrace? stackTrace]) =>
  ...
  /// See [log] for information on how non-String [message] arguments are
  /// handled.
  void fine(Map<String, String>? TESTMESSAGE, Object? message, [Object? error, StackTrace? stackTrace]) =>
  ...
  /// See [log] for information on how non-String [message] arguments are
  /// handled.
  void config(Map<String, String>? TESTMESSAGE, Object? message, [Object? error, StackTrace? stackTrace]) =>
  ...
  /// See [log] for information on how non-String [message] arguments are
  /// handled.
  void info(Map<String, String>? TESTMESSAGE, Object? message, [Object? error, StackTrace? stackTrace]) =>
  ...
  /// See [log] for information on how non-String [message] arguments are
  /// handled.
  void warning(Map<String, String> TESTMESSAGE, Object? message, [Object? error, StackTrace? stackTrace]) =>
  ...
  /// See [log] for information on how non-String [message] arguments are
  /// handled.
  void severe(Map<String, String> TESTMESSAGE, Object? message, [Object? error, StackTrace? stackTrace]) =>
  ...
  /// See [log] for information on how non-String [message] arguments are
  /// handled.
  void shout(Map<String, String> TESTMESSAGE, Object? message, [Object? error, StackTrace? stackTrace]) =>
